      ...
      <div className="w-full flex items-center justify-end space-x-2 pr-2">
        ...
        <button
          ...
          onClick={(e) => {
            ...
            newItemD.multiplePics = mulPics;
            if (mulPics) {
              newItemD.minPics = parseInt(
                (document.getElementById("minPicsInput")! as HTMLInputElement)
                  .value
              );
              newItemD.maxPics = parseInt(
                (document.getElementById("maxPicsInput")! as HTMLInputElement)
                  .value
              );
            }
            newItemD.maxPicSize = parseInt(
              (document.getElementById("picSizeInput")! as HTMLSelectElement)
                .value
            );
            newItemD.size = (
            ...
            setMulPics(newItemD.multiplePics!);
            (document.getElementById("editItemD")! as HTMLFormElement).reset();
            document.getElementById("colorValue")!.className =
              "w-full h-6 bg-white px-2";
            document.getElementById("colorValueName")!.innerHTML = "white";
